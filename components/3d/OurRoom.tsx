...
function CozyDioramaRoom() {
  return (
    <group position={[0, -1.2, -1]}>
      ...
      {/* 5. Right Wall (Warm Cream Half Wall) */}
...
// ─── 3D PROPS & FURNITURE (Refined & Non-overlapping) ─────────
...
function DeskAndComputer({ interactive }: { interactive: boolean }) {
  return (
    <group position={[2.0, -1.18, -3.2]}>
      ...
      {/* Retro Computer (Centered on Desk) */}
      ...
      {/* Headphones (Placed on dedicated stand on the Right Side of Desk) */}
...
// 4. Side Table with Polaroid Camera (Memories)
